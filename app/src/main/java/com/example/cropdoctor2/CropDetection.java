...
public class CropDetection extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        databaseArtists = FirebaseDatabase.getInstance().getReference().child("Remedies");
      //  adddata();
               ...
               // Toast.makeText(getApplicationContext(),"here2",Toast.LENGTH_LONG).show();
                if (dataSnapshot.exists()){
                    for (DataSnapshot npsnapshot : dataSnapshot.getChildren()){
                        Movie l=npsnapshot.getValue(Movie.class);
                    //    Toast.makeText(getApplicationContext(),"here"+l,Toast.LENGTH_LONG).show();
                        movieList.add(l);
                    }
